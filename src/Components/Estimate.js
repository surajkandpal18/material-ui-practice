        ...
        <Grid container direction='row'>
            ...
            <Grid item container direction='column' alignItems='center' lg style={{marginRight:"2em",marginBottom:'25em'}} >
                {questions
                    ...
                    .map((question,index)=>(
                        <React.Fragment key={index}>
                            <Grid item>
                                <Typography variant='h2' style={{fontWeight:500,fontSize:'2.25em',marginTop:'5em'}}>
                                     {question.title}
                                </Typography>
                             ...
                             {question.options.map(option=>(
                                <Grid item container direaction='column' justify='center' style={{maxWidth:'20em'}} md>
                                    ...
                                    <Grid item>
                                        <img src={option.icon} className={classes.icon} alt={option.iconAlt} />
                                    </Grid>
               ...
               <Grid item container justify='space-between' style={{width:'18em',marginTop:'3em'}} >
                <Grid item>
                    <IconButton  disabled={navigationPreviousDisabled()} onClick={previousQuestion} > <img src={navigationPreviousDisabled()?backArrowDisabled: backArrow} alt='prev' /></IconButton>
                   
                </Grid>
                <Grid item>
                    <IconButton disabled={navigationNextDisabled()} onClick={nextQuestion} > <img src={navigationNextDisabled()?forwardArrowDisabled: forwardArrow} alt='next' /></IconButton>
                </Grid>
