    	...
    	<Grid container direction='column' classname={classes.mainContainer}>
    				...
    				<Grid sm item className={classes.heroTextContainer}>
    					...
    					<br/> to the MidWest
       					...
       					<Grid container justify='center' className={classes.buttonContainer}>
    						<Grid item>
    							<Button className={classes.estimateButton} component={Link} to='/estimate' onClick={()=>{props.setValue(5)}} variant='contained'>Free Estimate</Button>
    						</Grid>
    						<Grid item>
    							<Button variant='outlined' className={classes.learnButtoHero} component={Link} to='/revolution' onClick={()=>{props.setValue(2)}}>
            ...
            <Grid item >{/*------------------------Custom Software Block---------------*/}
             ...
             <Grid item >{/*------------------------IOS/Android App---------------*/}
                <Grid container className={classes.serviceContainer} direction='row' justify={matchesSM?"center":"flex-end"}>
                    <Grid item style={{marginLeft:matchesSM?0:'5em',textAlign:matchesSM?"center":undefined}}>
                        <Typography variant='h4'>
                    ...
                    <Grid item  style={{marginRight:matchesSM?0:'5em'}}>
                        <img  className={classes.icon} src={mobileAppsIcon} alt="mobileAppsIconlogo" />
                    </Grid>
                </Grid>
            </Grid>
        <Grid item >{/*------------------------Websites--------------*/}
                <Grid container className={classes.serviceContainer} direction='row' justify={matchesSM?"center":undefined}>
                    ...
                    <Grid item  style={{marginRight:matchesSM?0:'5em'}}>
                        <img  className={classes.icon} src={websitesIcon} alt="websiteIconlogo" />
                    </Grid>
                </Grid>
            </Grid>
                        ...
                        <Grid container direction='column' style={{textAlign:"center"}}>
                            ...
                            <Grid item >
                                ...
                                Visionary Insights coupled with cutting-edge technology is a recipie for revolution
                                 ...
                                 <Button variant='outlined' component={Link} to='/revolution' component={Link} to='/customsoftwares' onClick={()=>{props.setValue(2)}} className={classes.learnButton}>
                                <span style={{marginRight: 10}}>Learn More</span>
                        <ButtonArrow height={10} width={10} fill={theme.palette.common.blue}/>
                        </Button>
                            </Grid>
            ...
            <Grid item>{/*------------------------Information Block--------------*/}
                <Grid container className={classes.infoBackground} direction='row' style={{height:'80em'}} alignItems='center'>
                    <Grid item sm container style={{textAlign:matchesXS?'center':'inherit'}} direction={matchesXS?'column':'row'}>
                        <Grid item style={{marginLeft:matchesXS?0:matchesSM?'2em':'5em'}} spacing={matchesXS?10:0}>
                    <Grid container direction="column" >
                        ...
                        <Grid item>
                        <Button variant='outlined' style={{color:'white',borderColor:'white'}} component={Link} to='/about'  onClick={()=>{props.setValue(3)}} className={classes.learnButton}>
                                <span style={{marginRight: 10}}>Learn More</span>
                    ...
                    <Grid container direction="column" >
                        ...
                        <Grid item>
                        <Button variant='outlined' style={{color:'white',borderColor:'white'}} component={Link} to='/contact' onClick={()=>{props.setValue(4)}} className={classes.learnButton}>
                                <span style={{marginRight: 10}}>Learn More</span>
                        <ButtonArrow height={10} width={10} fill='white'/>
                        </Button>
                        </Grid>
